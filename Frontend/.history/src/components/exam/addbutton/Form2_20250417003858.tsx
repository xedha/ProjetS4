...
function Form2({ setShowPopup }: FormProps) {
  ...
  return (
    <>
      ...
      Menu
      <input className={styles.inp} type="checkbox" defaultChecked />
      ...
      <section className={styles.menuContainer}>
        <div className={styles.menuList}>Food</div>
        <div className={styles.menuList}>Entertainment</div>
        <div className={styles.menuList}>Blog</div>
        <div className={styles.menuList}>Location</div>
      </section>
    </label>
              </div>
