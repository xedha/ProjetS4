        ...
        <div className={styles.content}>
          <form action="#">
            <div className={styles.userDetails}>
              {[
                ['Academic Year', year, (e: any) => setYear(e.target.value), 'select', ['1', '2', '3', '4', '5']],
                ['Formation', formation, (e: any) => setFormation(e.target.value)],
                ['Section', section, (e: any) => setSection(e.target.value)],
                ['Period', period, (e: any) => setPeriod(e.target.value), 'select', ['S1', 'S2', 'Resit']],
                ...
                <div className={styles.inputBox} key={i}>
                  ...
                  {type === 'select' ? (
                    <select value={value} onChange={setter} required>
