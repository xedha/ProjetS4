...
function AddButton({ onUploadSuccess }: AddButtonProps) {
    ...
    if (file) {
      ...
      if (file.type === 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' || 
        ...
        try {
          ...
          // Call the API to upload the Excel file for teaching assignments
          const result = await api.uploadExcel('chargesenseignement', file);
          ...
          message += `Inserted: ${insertedCount} teaching assignments\n`;
          message += `Skipped: ${skippedCount} assignments`;
  ...
  const downloadTemplate = () => {
    // Create a sample Excel template for teaching assignments
    const templateData = [
      ['palier', 'specialite', 'semestre', 'section', 'groupe', 'type', 'intitule_module', 'abv_module', 'Code_Enseignant', 'annee_universitaire', 'formation_id'],
      ['L3', 'Informatique', 'S5', 'A', '1', 'CM', 'Programmation Web', 'PW', 'ENS001', '2024/25', '1'],
      ['M1', 'Informatique', 'S1', 'A', '2', 'TD', 'Intelligence Artificielle', 'IA', 'ENS002', '2024/25', '2']
    ];
    ...
    link.setAttribute('download', 'teaching_assignments_template.csv');
            ...
            >
              ...
              <div style={{ padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                <div style={{
                  ...
                  <p style={{ margin: '0 0 20px 0', color: '#6b7280', fontSize: '14px' }}>
                    Select a file from your computer to import teaching assignments
                  </p>
                  <button
                    style={{
                      display: 'inline-flex',
              ...
              <div style={{
                ...
                <p style={{ margin: 0, fontSize: '12px', color: '#6b7280', lineHeight: 1.8 }}>
                  <strong style={{ color: '#374151', fontWeight: 600 }}>palier</strong> (L1, L2, L3, M1, M2), 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> specialite</strong>, 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> semestre</strong> (S1-S6), 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> section</strong> (A, B, C), 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> groupe</strong> (1, 2, 3), 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> type</strong> (CM, TD, TP), 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> intitule_module</strong>, 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> abv_module</strong>, 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> Code_Enseignant</strong> (must exist), 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> annee_universitaire</strong> (YYYY/YY), 
                  <strong style={{ color: '#374151', fontWeight: 600 }}> formation_id</strong> (optional)
                </p>
              </div>
            </div>
          </div>
