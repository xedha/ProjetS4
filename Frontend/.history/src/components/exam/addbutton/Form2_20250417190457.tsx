...
function Form2({ setShowPopup }: FormProps) {
  ...
  const generateSchedule = () => {
    console.log("Generating schedule for:", { year, Spec, section, period });
          ...
          <form action="#">
            <div className={styles.userDetails}>
              ...
              <div className={styles.inputBox}>
                ...
                <input type="text" list="formation-options" value={formation} onChange={(e) => setFormation(e.target.value)} required />
              ...
              <div className={styles.inputBox}>
                ...
                <input type="text" value={examRoom} onChange={(e) => setExamRoom(e.target.value)} required />
              </div>
              ...
              <div className={styles.inputBox}>
                ...
                <input type="text" value={moduleAbbreviation} onChange={(e) => setModuleAbbreviation(e.target.value)} required />
              </div>
              ...
              {Array.from({ length: nbrSS }).map((_, i) => (
                <div className={styles.inputBox} key={`email-${i}`}>
                  ...
                  <input type="email" value={emails[i] || ''} onChange={(e) => handleEmailChange(i, e.target.value)} required />
                </div>
              ))}
